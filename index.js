...
var game = new Game();
console.log('[Debug] New game!',game);
...
// 	console.log('\033c');
// 	game.displayText('Hangman - THE GAME','=');
...
// 		game.displayText('Congratulations! You won.','=');
// 		gameWord.guessed = true;
// 	} else  if	(gameWord.guesses <= 0) {
// 		game.displayText('YOU LOST. HA HA','=');
// 	}
...
// 		} else {
// 			console.log('\033c');
// 			game.displayText('Thanks for playing!!!','=');
// 			game.displayText('You won ' + game.wins + ' games, and lost ' + game.losses + ' games.','-');
// 		}
// 	}	
// }
